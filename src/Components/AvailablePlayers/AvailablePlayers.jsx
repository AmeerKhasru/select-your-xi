...
// Added handleSelectPlayer to props
                    ...
                    <div key={player.playerId} className="card bg-base-100 shadow-xl border border-gray-100">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-between items-center mt-4">
                                ...
                                {/* Updated Button: Attached the onClick handler */}
                                <button 
                                    onClick={() => handleSelectPlayer(player)}
                                    className="btn btn-sm btn-outline hover:bg-[#E7FE29] hover:border-none hover:text-black"
                                >
                                    Choose Player
                                </button>
                            </div>
